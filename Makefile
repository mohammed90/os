...
$(eval $(call build-package,glibc,2.37-r1))
...
$(eval $(call build-package,sqlite,3.40.1-r2))
$(eval $(call build-package,xz,5.4.1-r2))
$(eval $(call build-package,python-3.11,3.11.1-r5))
...
$(eval $(call build-package,py3-installer,0.5.1-r3))
...
$(eval $(call build-package,py3-more-itertools,9.0.0-r3))
$(eval $(call build-package,py3-setuptools-stage0,52.0.0-r2))
$(eval $(call build-package,py3-setuptools,59.4.0-r4,py3-setuptools))
...
$(eval $(call build-package,py3-pip,23.0.1-r0))
...
$(eval $(call build-package,ruby-3.2,3.2.0-r4))
...
$(eval $(call build-package,libgit2,1.5.1-r2))
$(eval $(call build-package,meson,1.0.0-r2))
$(eval $(call build-package,wasi-libc,0.20220525-r2))
$(eval $(call build-package,rust,1.67.0-r0))
$(eval $(call build-package,rustup,1.25.1-r0))
$(eval $(call build-package,libcap,2.26-r2))
$(eval $(call build-package,tree,2.1.0-r2))
$(eval $(call build-package,bubblewrap,0.7.0-r2))
...
$(eval $(call build-package,jenkins,2.392-r1))
...
$(eval $(call build-package,envoy,1.25.0-r0))
$(eval $(call build-package,redis,7.0.8-r0))
...
$(eval $(call build-package,pwgen,2.08-r0))
...
$(eval $(call build-package,rabbitmq-server,3.11.9-r1))
...
$(eval $(call build-package,rustls-ffi,0.8.2-r0))
...
$(eval $(call build-package,python-3.10,3.10.9-r0))
$(eval $(call build-package,aws-cli,1.27.38-r0))
$(eval $(call build-package,helm,3.11.1-r0))
...
$(eval $(call build-package,flux,0.40.1-r0))
...
$(eval $(call build-package,traefik,2.9.8-r0))
...
$(eval $(call build-package,policy-controller,0.6.2-r2))
